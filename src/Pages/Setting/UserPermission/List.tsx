    ...
    <div className="col-span-4 overflow-y-scroll" style={{
      ...
      <div className="flex flex-col bg-white dark:bg-gray-700 rounded-md shadow">
        ...
        <div className="border-y dark:border-gray-800">
          {users.map(user => {
            return (
              <Link key={user.id} to={`/setting/user/permission/${user.id}`} className={classNames("flex items-center space-x-1 justify-between hover:bg-gray-100 dark:hover:bg-gray-800 border-r-4 hover:border-primary-0 py-2 px-4 hover:pl-6 hover:font-medium capitalize transition-all", {
